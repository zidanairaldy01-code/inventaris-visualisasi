    ...
    <div className="p-6">
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            onClick={() => router.push('/petugas-input/distribusi/bulk')}
              ...
              return (
                <div key={grup.key} className={`rounded-xl border-2 ${borderClass} overflow-hidden shadow-sm`}>
                  ...
                  <button
                    ...
                    className={`w-full ${headerBg} px-4 py-3 flex items-center justify-between gap-3 hover:brightness-95 transition-all text-left`}
                  >
